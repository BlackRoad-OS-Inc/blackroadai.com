...
- [ ] Deploy index.html to blackroadai.com
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://blackroadai.com with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: Passenger (Ollama), Roadies (vLLM), RAG System, AI Router, AI Skills
...
**Milestone**: First paying customer through blackroadai.com.
...
**Milestone**: blackroadai.com is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: ai | Products: Passenger (Ollama), Roadies (vLLM), RAG System, AI Router, AI Skills*
